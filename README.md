...
AI Engineer building production ML systems — from RAG pipelines and CV models to MLOps. Currently @ Aaseya IT Services.
...
- **LLMs & GenAI** — RAG pipelines, prompt engineering, agentic workflows with OpenAI & open-source models
- **Computer Vision** — detection, recognition, and real-time inference systems with OpenCV / TensorFlow / Keras
- **NLP & Classical ML** — sentiment analysis, text classification, feature engineering with scikit-learn
